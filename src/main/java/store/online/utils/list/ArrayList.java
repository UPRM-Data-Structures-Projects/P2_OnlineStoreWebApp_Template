package store.online.utils.list;
...
public class ArrayList<E> implements List<E> {
	...
	public String toString() {
		...
		for (int i = 0; i < this.currentSize; i++) {
			if (i > 0)
				sb.append(", ");
			sb.append(String.valueOf(this.elements[i]));
		}
		sb.append(']');
		return sb.toString();
	}
	...
	/**
	 * This function is exclusively for spring to understand
	 * that this class can be parsed into a json that serves as
	 * response for web service api.
	 * 
	 * @return json
	 */
